...
void PREVIEW::CreatePreviewForModel(GLuint& PreviewTexture, const char* FilePath , Shader& PreviewShader)
{
	FBO fbo;
	...
	fbo.DeleteFBO();
	fbo.DeleteRBO();
	*PreviewModel.GetModelIDcounterptr() -= 1;
}
